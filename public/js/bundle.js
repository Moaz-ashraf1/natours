(() => {
  ...
  var displayMap = (locations) => {
    mapboxgl.accessToken = "pk.eyJ1IjoibW9hemFzaHJhZiIsImEiOiJjbGtzOXU5MjEwMW0wM2RvYjhjbTBneDd1In0.paHLQEEw-LrDfejnMI-88w";
  ...
  var updateSettings = async (data, type) => {
    try {
      const url = type === "data" ? "http://127.0.0.1:8000/api/v1/users/updateMe" : "http://127.0.0.1:8000/api/v1/users/updateMyPassword";
      const res = await axios_default({
        method: "PATCH",
        url,
        data
